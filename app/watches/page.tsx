        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              <Search className="w-5 h-5 text-black hover:text-yellow-600 transition-colors" />
              <User className="w-5 h-5 text-black hover:text-yellow-600 transition-colors" />
              <div className="relative">
                <ShoppingBag className="w-5 h-5 text-black hover:text-yellow-600 transition-colors" />
                {cartItems > 0 && (

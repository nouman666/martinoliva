...
export default function DiamondsPage() {
  ...
  // same hooks used on the homepage
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[70vh] md:h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl leading-relaxed mb-0 max-w-2xl mx-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className={viewMode === 'grid' ? "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8" : "space-y-6"}>
          {diamonds.map((diamond) => (
            <Card key={diamond.id} className="group hover:shadow-xl transition-all duration-300 border-0 shadow-md">
